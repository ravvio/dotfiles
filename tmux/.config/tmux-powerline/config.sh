...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/yt/3msc22_16d79bnxyjpcbvrvc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="alessio.raviola.98@gmail.com"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/alessioraviola/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/alessioraviola/.mailcheckrc"
# }
