...
let magenta = "#d3869b"
let magentadark = "#b14286"
let l_magenta = "#945e80"

let acqua = "#8ec07c"
let acquadark = "#689d6a"
let l_acqua = "#4c7a5d"
...
$env.config = {
    ...
    color_config: $gruvbox_material_theme # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
